<section class="page_breadcrumbs ds background_cover section_padding_top_65 section_padding_bottom_65">
			...
			<section class="ls section_padding_top_100 section_padding_bottom_100">
				<div class="container">
					<div class="row">
						<?php echo form_open('guest', 'class="shop-register"'); ?>
							<div class="col-sm-6">
						...
						</label> <input type="email" required="required" class="form-control " name="reg_no" > </div>
						...
						<div class="form-group validate-required validate-email" id="billing_email"> <label for="billing_email" class="control-label">
							...
							<div class="col-sm-6">
								<div class="form-group validate-required" id=""> <label for="" class="control-label">
							<span class="grey">Location Address <i class="fa fa-map-marker"></i></span>
							<span class="required">*</span>
							 <span style="font-size: 9px;" class="text-danger"><?php echo form_error('location'); ?></span> 
						</label> <input type="text" required="required" class="form-control " name="location" > </div>								
							</div>
						...
						<select name="department"  id="level">
							...
							<option value="Social Media">Social Media</option>
								...
								<div class="form-group">
									...
									<input required="required" type="checkbox"> I have agree with Guest<a href="#">Terms and Conditions</a>
								</label> </div>
									</div>
								</div>
							</div>
